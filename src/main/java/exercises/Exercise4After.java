...
public class Exercise4After {
     ...
     * Concrete Mediator Classes: We created separate mediator classes (Warehouse, PaymentSystem, ShippingSystem) that implement the OrderMediator interface. Each mediator is responsible for specific tasks related to orders.
    ...
    public static class Main {
        public static void main(String[] args) {
            ...
            OrderMediator paymentSystem = new PaymentSystem();
            OrderMediator shippingSystem = new ShippingSystem();
