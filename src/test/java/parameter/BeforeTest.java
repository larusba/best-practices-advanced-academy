...
class BeforeTest {
    @Test
    void test_not_null1() { // Noncompliant. The 3 following tests differ only by one hardcoded
        // number.
        setupTax();
    ...
    @Test
    void testLevel1() { // Noncompliant. The 3 following tests differ only by a few hardcoded
        // numbers.
        setLevel(1);
        runGame();
